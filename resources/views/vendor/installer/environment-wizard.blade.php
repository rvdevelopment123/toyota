        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Intelle-Stock-Manager" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_name" id="database_name" value="inventory" placeholder="{{ trans('installer_messages.environment.wizard.form.db_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_username" id="database_username" value="root" placeholder="{{ trans('installer_messages.environment.wizard.form.db_username_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="database_password" id="database_password" value="secret" placeholder="{{ trans('installer_messages.environment.wizard.form.db_password_placeholder') }}" />
