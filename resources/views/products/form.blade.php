    ...
    <div class="example-box-wrapper"> 
		{!! Form::model($product,['method' => 'post', 'files' => true, 'class' => 'form-horizontal bordered-row', 'id' => 'ism_form']) !!}
			...
			<div class="form-group" id="carDetails">
				...
				<div class="col-sm-4">
					{!! Form::text('vin', $product->vin, ['class' => 'form-control']) !!}
				</div>
			</div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
			$('#category_id').on('change', function() {
				...
				if (categoryName.toLowerCase() == 'cars' || categoryName.toLowerCase() == 'car') {
					$('div#carDetails').css('display', 'block');
				} else {
					$('div#carDetails').css('display', 'none');
				}
